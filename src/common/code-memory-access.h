  ...
  class V8_EXPORT JitPageReference {
   public:
    ...
    JitAllocation& LookupAllocation(base::Address addr, size_t size,
                                    JitAllocationType type);
    bool Contains(base::Address addr, size_t size, JitAllocationType type);
...
class WritableJitAllocation {
 public:
  WritableJitAllocation(const WritableJitAllocation&) V8_NOEXCEPT;
...
class WritableJumpTablePair {
 ...
 private:
  ...
  WritableJumpTablePair(WritableJitAllocation jump_table,
                        WritableJitAllocation far_jump_table);
