...
#if V8_TARGET_ARCH_X64 && V8_BUILTINS_INSTRUCTION_SET_EXTENSION
#define V8_ENABLE_ISX_BUILTIN true
#endif  // V8_TARGET_ARCH_X64 && V8_BUILTINS_INSTRUCTION_SET_EXTENSION
