...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kaccess_string = 0x422d;
  static constexpr Tagged_t kaccessor_string = 0x4241;
  static constexpr Tagged_t kadd_string = 0x4255;
  static constexpr Tagged_t kaddInitializer_string = 0x4265;
  static constexpr Tagged_t kAggregateError_string = 0x4281;
  static constexpr Tagged_t kalways_string = 0x429d;
  static constexpr Tagged_t kanonymous_string = 0x42b1;
  static constexpr Tagged_t kapply_string = 0x42c9;
  static constexpr Tagged_t kArguments_string = 0x42dd;
  static constexpr Tagged_t karguments_string = 0x42f5;
  static constexpr Tagged_t karguments_to_string = 0x430d;
  static constexpr Tagged_t kArray_string = 0x432d;
  static constexpr Tagged_t karray_to_string = 0x4341;
  static constexpr Tagged_t kArrayBuffer_string = 0x435d;
  static constexpr Tagged_t kArrayIterator_string = 0x4375;
  static constexpr Tagged_t kas_string = 0x4391;
  static constexpr Tagged_t kassert_string = 0x43a1;
  static constexpr Tagged_t kasync_string = 0x43b5;
  static constexpr Tagged_t kAtomicsCondition_string = 0x43c9;
  static constexpr Tagged_t kAtomicsMutex_string = 0x43e9;
  static constexpr Tagged_t kauto_string = 0x4405;
  static constexpr Tagged_t kBigInt_string = 0x4415;
  static constexpr Tagged_t kbigint_string = 0x4429;
  static constexpr Tagged_t kBigInt64Array_string = 0x443d;
  static constexpr Tagged_t kBigUint64Array_string = 0x4459;
  static constexpr Tagged_t kbind_string = 0x4475;
  static constexpr Tagged_t kblank_string = 0x4485;
  static constexpr Tagged_t kBoolean_string = 0x4499;
  static constexpr Tagged_t kboolean_string = 0x44ad;
  static constexpr Tagged_t kboolean_to_string = 0x44c1;
  static constexpr Tagged_t kbound__string = 0x44dd;
  static constexpr Tagged_t kbuffer_string = 0x44f1;
  static constexpr Tagged_t kbyte_length_string = 0x4505;
  static constexpr Tagged_t kbyte_offset_string = 0x451d;
  static constexpr Tagged_t kCompileError_string = 0x4535;
  static constexpr Tagged_t kcalendar_string = 0x454d;
  static constexpr Tagged_t kcallee_string = 0x4561;
  static constexpr Tagged_t kcaller_string = 0x4575;
  static constexpr Tagged_t kcause_string = 0x4589;
  static constexpr Tagged_t kcharacter_string = 0x459d;
  static constexpr Tagged_t kclass_string = 0x45b5;
  ...
  static constexpr Tagged_t kfield_string = 0x4a99;
  static constexpr Tagged_t kfields_string = 0x4aad;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x4ac1;
  static constexpr Tagged_t kflags_string = 0x4ae1;
  static constexpr Tagged_t kFloat16Array_string = 0x4af5;
  static constexpr Tagged_t kFloat32Array_string = 0x4b0d;
  static constexpr Tagged_t kFloat64Array_string = 0x4b25;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x4b3d;
  static constexpr Tagged_t kfrom_string = 0x4b61;
  static constexpr Tagged_t kFunction_string = 0x4b71;
  static constexpr Tagged_t kfunction_native_code_string = 0x4b85;
  static constexpr Tagged_t kfunction_string = 0x4bb1;
  static constexpr Tagged_t kfunction_to_string = 0x4bc5;
  static constexpr Tagged_t kGenerator_string = 0x4be5;
  static constexpr Tagged_t kget_space_string = 0x4bfd;
  static constexpr Tagged_t kget_string = 0x4c0d;
  static constexpr Tagged_t kgetter_string = 0x4c1d;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x4c31;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x4c55;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x4c79;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x4c9d;
  static constexpr Tagged_t kglobal_string = 0x4cb9;
  static constexpr Tagged_t kglobalThis_string = 0x4ccd;
  static constexpr Tagged_t kgroups_string = 0x4ce5;
  static constexpr Tagged_t kgrowable_string = 0x4cf9;
  static constexpr Tagged_t khas_string = 0x4d0d;
  static constexpr Tagged_t khasIndices_string = 0x4d1d;
  static constexpr Tagged_t khour_string = 0x4d35;
  static constexpr Tagged_t khours_string = 0x4d45;
  static constexpr Tagged_t khoursInDay_string = 0x4d59;
  static constexpr Tagged_t kignoreCase_string = 0x4d71;
  static constexpr Tagged_t kid_string = 0x4d89;
  static constexpr Tagged_t killegal_access_string = 0x4d99;
  static constexpr Tagged_t killegal_argument_string = 0x4db5;
  static constexpr Tagged_t kinLeapYear_string = 0x4dd1;
  static constexpr Tagged_t kindex_string = 0x4de9;
  static constexpr Tagged_t kindices_string = 0x4dfd;
  static constexpr Tagged_t kInfinity_string = 0x4e11;
  static constexpr Tagged_t kinfinity_string = 0x4e25;
  static constexpr Tagged_t kinit_string = 0x4e39;
  static constexpr Tagged_t kinput_string = 0x4e49;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x4e5d;
  static constexpr Tagged_t kInt16Array_string = 0x4e89;
  static constexpr Tagged_t kInt32Array_string = 0x4ea1;
  static constexpr Tagged_t kInt8Array_string = 0x4eb9;
  static constexpr Tagged_t kisExtensible_string = 0x4ed1;
  static constexpr Tagged_t kiso8601_string = 0x4ee9;
  static constexpr Tagged_t kisoDay_string = 0x4efd;
  static constexpr Tagged_t kisoHour_string = 0x4f11;
  static constexpr Tagged_t kisoMicrosecond_string = 0x4f25;
  static constexpr Tagged_t kisoMillisecond_string = 0x4f41;
  static constexpr Tagged_t kisoMinute_string = 0x4f5d;
  static constexpr Tagged_t kisoMonth_string = 0x4f75;
  static constexpr Tagged_t kisoNanosecond_string = 0x4f89;
  static constexpr Tagged_t kisoSecond_string = 0x4fa5;
  static constexpr Tagged_t kisoYear_string = 0x4fbd;
  static constexpr Tagged_t kIterator_string = 0x4fd1;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4fe5;
  static constexpr Tagged_t kjsMemoryRange_string = 0x5001;
  static constexpr Tagged_t kkeys_string = 0x501d;
  static constexpr Tagged_t kkind_string = 0x502d;
  static constexpr Tagged_t klargestUnit_string = 0x503d;
  static constexpr Tagged_t klastIndex_string = 0x5055;
  static constexpr Tagged_t klet_string = 0x506d;
  static constexpr Tagged_t kline_string = 0x507d;
  static constexpr Tagged_t klinear_string = 0x508d;
  static constexpr Tagged_t kLinkError_string = 0x50a1;
  static constexpr Tagged_t klong_string = 0x50b9;
  static constexpr Tagged_t kMap_string = 0x50c9;
  static constexpr Tagged_t kMapIterator_string = 0x50d9;
  static constexpr Tagged_t kmax_byte_length_string = 0x50f1;
  static constexpr Tagged_t kmedium_string = 0x510d;
  static constexpr Tagged_t kmergeFields_string = 0x5121;
  static constexpr Tagged_t kmessage_string = 0x5139;
  static constexpr Tagged_t kmeta_string = 0x514d;
  static constexpr Tagged_t kmethod_string = 0x515d;
  static constexpr Tagged_t kminus_Infinity_string = 0x5171;
  static constexpr Tagged_t kmicrosecond_string = 0x5189;
  static constexpr Tagged_t kmicroseconds_string = 0x51a1;
  static constexpr Tagged_t kmillisecond_string = 0x51b9;
  static constexpr Tagged_t kmilliseconds_string = 0x51d1;
  static constexpr Tagged_t kminute_string = 0x51e9;
  static constexpr Tagged_t kminutes_string = 0x51fd;
  static constexpr Tagged_t kModule_string = 0x5211;
  static constexpr Tagged_t kmonth_string = 0x5225;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x5239;
  static constexpr Tagged_t kmonths_string = 0x5259;
  static constexpr Tagged_t kmonthsInYear_string = 0x526d;
  static constexpr Tagged_t kmonthCode_string = 0x5285;
  static constexpr Tagged_t kmultiline_string = 0x529d;
  static constexpr Tagged_t kNaN_string = 0x52b5;
  static constexpr Tagged_t knanosecond_string = 0x52c5;
  static constexpr Tagged_t knanoseconds_string = 0x52dd;
  static constexpr Tagged_t knarrow_string = 0x52f5;
  static constexpr Tagged_t knative_string = 0x5309;
  static constexpr Tagged_t kNFC_string = 0x531d;
  static constexpr Tagged_t kNFD_string = 0x532d;
  static constexpr Tagged_t kNFKC_string = 0x533d;
  static constexpr Tagged_t kNFKD_string = 0x534d;
  static constexpr Tagged_t knot_equal_string = 0x535d;
  static constexpr Tagged_t knull_string = 0x5375;
  static constexpr Tagged_t knull_to_string = 0x5385;
  static constexpr Tagged_t kNumber_string = 0x53a1;
  static constexpr Tagged_t knumber_string = 0x53b5;
  static constexpr Tagged_t knumber_to_string = 0x53c9;
  static constexpr Tagged_t kObject_string = 0x53e5;
  static constexpr Tagged_t kobject_string = 0x53f9;
  static constexpr Tagged_t kobject_to_string = 0x540d;
  static constexpr Tagged_t kObject_prototype_string = 0x5429;
  static constexpr Tagged_t koffset_string = 0x5445;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x5459;
  static constexpr Tagged_t kok_string = 0x5479;
  static constexpr Tagged_t kother_string = 0x5489;
  static constexpr Tagged_t koverflow_string = 0x549d;
  static constexpr Tagged_t kownKeys_string = 0x54b1;
  static constexpr Tagged_t kpercent_string = 0x54c5;
  static constexpr Tagged_t kplainDate_string = 0x54d9;
  static constexpr Tagged_t kplainTime_string = 0x54f1;
  static constexpr Tagged_t kposition_string = 0x5509;
  static constexpr Tagged_t kpreventExtensions_string = 0x551d;
  static constexpr Tagged_t kprivate_string = 0x553d;
  static constexpr Tagged_t kprivate_constructor_string = 0x5551;
  static constexpr Tagged_t kPromise_string = 0x5569;
  static constexpr Tagged_t kpromise_string = 0x557d;
  static constexpr Tagged_t kproto_string = 0x5591;
  static constexpr Tagged_t kproxy_string = 0x55a9;
  static constexpr Tagged_t kProxy_string = 0x55bd;
  static constexpr Tagged_t kquery_colon_string = 0x55d1;
  static constexpr Tagged_t kRangeError_string = 0x55e1;
  static constexpr Tagged_t kraw_json_string = 0x55f9;
  static constexpr Tagged_t kraw_string = 0x560d;
  static constexpr Tagged_t kReferenceError_string = 0x561d;
  static constexpr Tagged_t kReflectGet_string = 0x5639;
  static constexpr Tagged_t kReflectHas_string = 0x5651;
  static constexpr Tagged_t kRegExp_string = 0x5669;
  static constexpr Tagged_t kregexp_to_string = 0x567d;
  static constexpr Tagged_t kreject_string = 0x5699;
  static constexpr Tagged_t krelativeTo_string = 0x56ad;
  static constexpr Tagged_t kresizable_string = 0x56c5;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x56dd;
  static constexpr Tagged_t kreturn_string = 0x56fd;
  static constexpr Tagged_t krevoke_string = 0x5711;
  static constexpr Tagged_t kroundingIncrement_string = 0x5725;
  static constexpr Tagged_t kRuntimeError_string = 0x5745;
  static constexpr Tagged_t kWebAssemblyException_string = 0x575d;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x5781;
  static constexpr Tagged_t kScript_string = 0x57a1;
  static constexpr Tagged_t kscript_string = 0x57b5;
  static constexpr Tagged_t ksecond_string = 0x57c9;
  static constexpr Tagged_t kseconds_string = 0x57dd;
  static constexpr Tagged_t kshort_string = 0x57f1;
  static constexpr Tagged_t kSet_string = 0x5805;
  static constexpr Tagged_t ksentence_string = 0x5815;
  static constexpr Tagged_t kset_space_string = 0x5829;
  static constexpr Tagged_t kset_string = 0x5839;
  static constexpr Tagged_t ksetter_string = 0x5849;
  static constexpr Tagged_t kSetIterator_string = 0x585d;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x5875;
  static constexpr Tagged_t kShadowRealm_string = 0x5891;
  static constexpr Tagged_t kSharedArray_string = 0x58a9;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x58c1;
  static constexpr Tagged_t kSharedStruct_string = 0x58e1;
  static constexpr Tagged_t ksign_string = 0x58f9;
  static constexpr Tagged_t ksize_string = 0x5909;
  static constexpr Tagged_t ksmallestUnit_string = 0x5919;
  static constexpr Tagged_t ksource_string = 0x5931;
  static constexpr Tagged_t ksourceText_string = 0x5945;
  static constexpr Tagged_t kstack_string = 0x595d;
  static constexpr Tagged_t kstackTraceLimit_string = 0x5971;
  static constexpr Tagged_t kstatic_string = 0x598d;
  static constexpr Tagged_t kstatic_initializer_string = 0x59a1;
  static constexpr Tagged_t ksticky_string = 0x59c1;
  static constexpr Tagged_t kString_string = 0x59d5;
  static constexpr Tagged_t kstring_string = 0x59e9;
  static constexpr Tagged_t kstring_to_string = 0x59fd;
  static constexpr Tagged_t ksuppressed_string = 0x5a19;
  static constexpr Tagged_t kSuppressedError_string = 0x5a31;
  static constexpr Tagged_t kSymbol_iterator_string = 0x5a4d;
  static constexpr Tagged_t kSymbol_match_all_string = 0x5a69;
  static constexpr Tagged_t kSymbol_replace_string = 0x5a85;
  static constexpr Tagged_t ksymbol_species_string = 0x5aa1;
  static constexpr Tagged_t kSymbol_species_string = 0x5abd;
  static constexpr Tagged_t kSymbol_split_string = 0x5ad9;
  static constexpr Tagged_t kSymbol_string = 0x5af1;
  static constexpr Tagged_t ksymbol_string = 0x5b05;
  static constexpr Tagged_t kSyntaxError_string = 0x5b19;
  static constexpr Tagged_t ktarget_string = 0x5b31;
  static constexpr Tagged_t kthis_function_string = 0x5b45;
  static constexpr Tagged_t kthis_string = 0x5b61;
  static constexpr Tagged_t kthrow_string = 0x5b71;
  static constexpr Tagged_t ktimed_out_string = 0x5b85;
  static constexpr Tagged_t ktimeZone_string = 0x5b9d;
  static constexpr Tagged_t ktoJSON_string = 0x5bb1;
  static constexpr Tagged_t ktoString_string = 0x5bc5;
  static constexpr Tagged_t ktrue_string = 0x5bd9;
  static constexpr Tagged_t ktotal_string = 0x5be9;
  static constexpr Tagged_t kTypeError_string = 0x5bfd;
  static constexpr Tagged_t kUint16Array_string = 0x5c15;
  static constexpr Tagged_t kUint32Array_string = 0x5c2d;
  static constexpr Tagged_t kUint8Array_string = 0x5c45;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x5c5d;
  static constexpr Tagged_t kundefined_string = 0x5c7d;
  static constexpr Tagged_t kundefined_to_string = 0x5c95;
  static constexpr Tagged_t kunicode_string = 0x5cb5;
  static constexpr Tagged_t kunicodeSets_string = 0x5cc9;
  static constexpr Tagged_t kunit_string = 0x5ce1;
  static constexpr Tagged_t kURIError_string = 0x5cf1;
  static constexpr Tagged_t kUTC_string = 0x5d05;
  static constexpr Tagged_t kWeakMap_string = 0x5d15;
  static constexpr Tagged_t kWeakRef_string = 0x5d29;
  static constexpr Tagged_t kWeakSet_string = 0x5d3d;
  static constexpr Tagged_t kweek_string = 0x5d51;
  static constexpr Tagged_t kweeks_string = 0x5d61;
  static constexpr Tagged_t kweekOfYear_string = 0x5d75;
  static constexpr Tagged_t kwith_string = 0x5d8d;
  static constexpr Tagged_t kword_string = 0x5d9d;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x5dad;
  static constexpr Tagged_t kyear_string = 0x5dcd;
  static constexpr Tagged_t kyears_string = 0x5ddd;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x5df1;
  static constexpr Tagged_t kHashTableHoleValue = 0x5dfd;
  static constexpr Tagged_t kPromiseHoleValue = 0x5e09;
  static constexpr Tagged_t kUninitializedValue = 0x5e15;
  static constexpr Tagged_t kArgumentsMarker = 0x5e21;
  static constexpr Tagged_t kTerminationException = 0x5e2d;
  static constexpr Tagged_t kException = 0x5e39;
  static constexpr Tagged_t kOptimizedOut = 0x5e45;
  static constexpr Tagged_t kStaleRegister = 0x5e51;
  static constexpr Tagged_t kSelfReferenceMarker = 0x5e5d;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x5e69;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x5e75;
  static constexpr Tagged_t kcall_site_info_symbol = 0x5e85;
  static constexpr Tagged_t kclass_fields_symbol = 0x5e95;
  static constexpr Tagged_t kclass_positions_symbol = 0x5ea5;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x5eb5;
  static constexpr Tagged_t kerror_message_symbol = 0x5ec5;
  static constexpr Tagged_t kerror_script_symbol = 0x5ed5;
  static constexpr Tagged_t kerror_stack_symbol = 0x5ee5;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x5ef5;
  static constexpr Tagged_t kfrozen_symbol = 0x5f05;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x5f15;
  static constexpr Tagged_t knative_context_index_symbol = 0x5f25;
  static constexpr Tagged_t knonextensible_symbol = 0x5f35;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x5f45;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x5f55;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x5f65;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x5f75;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x5f85;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x5f95;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x5fa5;
  static constexpr Tagged_t ksealed_symbol = 0x5fb5;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5fc5;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5fd5;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5fe5;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5ff5;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x6005;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x6015;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x6025;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x6035;
  static constexpr Tagged_t kwasm_wrapped_object_symbol = 0x6045;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x6055;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x6065;
  static constexpr Tagged_t kasync_iterator_symbol = 0x6075;
  static constexpr Tagged_t kintl_fallback_symbol = 0x60a5;
  static constexpr Tagged_t kmatch_symbol = 0x60dd;
  static constexpr Tagged_t ksearch_symbol = 0x6105;
  static constexpr Tagged_t kunscopables_symbol = 0x6131;
  static constexpr Tagged_t kdispose_symbol = 0x6161;
  static constexpr Tagged_t kasync_dispose_symbol = 0x618d;
  static constexpr Tagged_t khas_instance_symbol = 0x61bd;
  static constexpr Tagged_t kto_string_tag_symbol = 0x61ed;
  static constexpr Tagged_t kconstructor_string = 0x6265;
  static constexpr Tagged_t knext_string = 0x627d;
  static constexpr Tagged_t kresolve_string = 0x628d;
  static constexpr Tagged_t kthen_string = 0x62a1;
  static constexpr Tagged_t kvalueOf_string = 0x62b1;
  static constexpr Tagged_t kiterator_symbol = 0x62c5;
  static constexpr Tagged_t kmatch_all_symbol = 0x62d5;
  static constexpr Tagged_t kreplace_symbol = 0x62e5;
  static constexpr Tagged_t kspecies_symbol = 0x62f5;
  static constexpr Tagged_t ksplit_symbol = 0x6305;
  static constexpr Tagged_t kto_primitive_symbol = 0x6315;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x6325;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x6335;
  static constexpr Tagged_t kEmptySymbolTable = 0x6359;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x6375;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x6389;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x639d;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x63a9;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x63c9;
  static constexpr Tagged_t kNativeScopeInfo = 0x63ed;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x6405;
  static constexpr Tagged_t kWasmNullPadding = 0x641d;
...
static constexpr std::array<Tagged_t, 779> StaticReadOnlyRootsPointerTable = {
    ...
    StaticReadOnlyRoot::kaccess_string,
    StaticReadOnlyRoot::kaccessor_string,
    StaticReadOnlyRoot::kadd_string,
    StaticReadOnlyRoot::kaddInitializer_string,
    ...
    StaticReadOnlyRoot::kclass_string,
    ...
    StaticReadOnlyRoot::kfield_string,
    ...
    StaticReadOnlyRoot::kgetter_string,
    ...
    StaticReadOnlyRoot::kinfinity_string,
    StaticReadOnlyRoot::kinit_string,
    ...
    StaticReadOnlyRoot::kkind_string,
    ...
    StaticReadOnlyRoot::kmethod_string,
    ...
    StaticReadOnlyRoot::kprivate_string,
    ...
    StaticReadOnlyRoot::kset_string,
    StaticReadOnlyRoot::ksetter_string,
    ...
    StaticReadOnlyRoot::kstatic_string,
