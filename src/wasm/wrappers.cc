...
class WasmWrapperTSGraphBuilder : public WasmGraphBuilderBase {
 public:
  ...
  OpIndex BuildLoadExternalPointerFromObject(V<Object> object, int offset,
  ...
  V<WordPtr> BuildSwitchToTheCentralStack(V<WordPtr> old_limit) {
    ...
    V<Object> active_continuation = LOAD_ROOT(ActiveContinuation);
    V<WordPtr> stack = BuildLoadExternalPointerFromObject(
