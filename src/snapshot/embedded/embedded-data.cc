...
EmbeddedData EmbeddedData::NewFromIsolate(Isolate* isolate) {
  ...
  std::vector<struct LayoutDescription> layout_descriptions(
      kTableSize + Builtins::kISXBuiltinCount);
