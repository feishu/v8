...
struct ReturnOp : OperationT<ReturnOp> {
  // spill_caller_frame_slots signals what all caller stack located return
  // values should be spilled before reaching InstructionSelector.
  // Growable stacks implementation does extra work to spill this values and
  // it cannot be performed during InstructionSelector lowering efficiently.
